...
- `kep_tax_id` — РНОКПП власника ключа (витягується з сертифікату при завантаженні)
...
## 8. Відомі обмеження та нерозв'язані питання

### 8.1 reg_doc/list для ЮО без реєстрації підписанта
...
### 8.2 probe-reports / probe-docs ендпоінти
...
### 8.3 Перемикач "Посадова особа / Фізична особа"
...
## 10. Нормалізація відповідей DPS API
