...
| 2026-04-01 | Dashboard: колонка "КЕП до" + секція "Строки дії КЕП" | У таблиці контрагентів додано дату КЕП з кольоровим індикатором; окрема секція показує всіх клієнтів з КЕП, відсортованих за терміновістю |
